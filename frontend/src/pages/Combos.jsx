  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Combos Disponibles</h1>
          <p className="text-gray-500">Selecciona un combo para comprar</p>
        </div>
          ...
          {combos.map((combo) => (
            <div key={combo.id} className="card hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">{combo.nombre}</h3>
